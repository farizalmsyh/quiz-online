                ...
                <div class="card bg-blue-dark">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <button class="float-right btn btn-outline-primary dropdown-toggle" type="button"
                                id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                <i class="align-middle" data-feather="send"></i>&nbsp; Posting
                            </button>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a type="modal" class="dropdown-item" href="#" data-toggle="modal" data-target="#createExamModal">Soal</a>
                                <a type="modal" class="dropdown-item" href="#" data-toggle="modal" data-target="#createAnnouncementModal">Pengumuman</a>
                            </div>
                            @endif
                            <a type="modal" class="text-decoration-none text-primary" href="#" data-toggle="modal" data-target="#memberModal">
      ...
      <div class="modal-body mb-3">
        ...
        <div style="max-height: 300px; overflow-y: auto;">
            ...
            @if(count($member) != 0)
                ...
                <div class="card-body">
                    @if($class->owner == \Auth::user()->id)
                    <a href="{{route('classroom.delete-member', [$value->user_id, $class->id])}}" class="float-right text-decoration-none text-danger"><i class="align-middle" data-feather="delete"></i></a>
                    @endif
...
<div class="modal fade" id="createExamModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
