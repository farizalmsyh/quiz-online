...
<main class="content">
    <div class="container-fluid p-0">
        <div class="row mb-3">
            <div class="col-12">
                <h4><a class="font-weight-bold text-decoration-none" href="#"><i class="align-middle" data-feather="open-book"></i> <span class="align-middle text-decoration-none">&nbsp;Daftar Kelas</a></h4>
            </div>
        </div>
        <div class="row">
